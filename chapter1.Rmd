...
test_function("ggplot", args = "aes",
              args_not_specified_msg = "Have you specified the argument `aes` in `ggplot`?",
              incorrect_msg = "Have you correctly specified the argument `aes` in `ggplot`?")
