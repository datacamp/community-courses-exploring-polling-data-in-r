...
Your plots look great! Now it's time to take a closer look at your polling data. Did you notice these polls are done at the state level? Especially during the primaries, campaigns tend to focus their effort on winning individual states, rather than maintaining popularity across the country. Rather than averaging across all the states, it might make sense to view polling data state-by-state.
