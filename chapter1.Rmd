...
However, a color gradient alone makes it difficult to identify specific polling numbers from each state. Ideally, you want your map to display general trends and specific information. To accomplish this, you'll use googleVis to generate an interactive map from your Sanders polling data.
...
Your Bernie Sanders polling data object (`sanders`) is preloaded into your environment.
